            ...
            <div class="row">
                <div class="col-12 col-sm-9">
                    <div class="thumb-wrapper clearfix">
                        <img v-for="item in allRetrievedVideos" :src=" 'images/' + item.movies_cover" alt="mediathumb" @click="loadNewMovie(movie)" class="img-thumbnail rounded float-left media-thumb">
                    </div>
                </div>
            </div>
        </section>
